...
class PaddleOCR private constructor(
    ...
    companion object {
        ...
        suspend fun create(context: Context): PaddleOCR {
            ...
            return createOnIo {
                OCREngine(appContext, PaddleOCRConfig(), EngineConfig())
            }
        }
        ...
        suspend fun create(
            ...
            val appContext = context.applicationContext
            return createOnIo {
                OCREngine(appContext, config, engineConfig)
            }
        }
        ...
        private suspend fun createOnIo(
            createEngine: () -> OCREngine,
        ): PaddleOCR {
            var createdEngine: OCREngine? = null
            return try {
                ...
                withContext(NonCancellable + Dispatchers.IO) {
                    try {
                        ...
                        // Preserve the original construction/cancellation failure.
