...
| [0011-local-resource-budget-first-capture.md](0011-local-resource-budget-first-capture.md) | 纯本地三轨采集以设备资源、权限与可测负担为先 | 已接受，5 条默认关闭通知 route 与本地 OCR 候选已实现，真机发布门未完成 |
