...
- 闪屏修复随后生成 `7/0.1.0-internal.7` 固定签名双 ABI 候选。arm64 友好命名 APK 为 90,773,049 bytes、SHA-256 `1033ddb8c753c626208b2d503063b5a1d9eb7f6aa906a6f51f330d99cc8003ff`；证书 pin、v2 单 signer、16 KiB 对齐、版本、ABI、最终权限、标签和图标静态复核通过。设备尚未得到本轮连接授权，故没有执行 ADB 安装，也不把闪屏交互写成通过。
