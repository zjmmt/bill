...
- [x] 2026-08-02 - 发行链在原始双 ABI 产物外生成并再次验签 `Bill-Local-Ledger-Android-{abi}.apk` 友好副本；内部签名 `6/0.1.0-internal.6` 已通过证书 pin、单 signer、16 KiB 对齐、最终权限和本地化标签/图标检查，真机覆盖安装另按采集可靠性计划验收。
- [x] 2026-08-02 - 截图反馈修复生成内部签名 `7/0.1.0-internal.7` 双 ABI 候选；arm64 友好包为 90,773,049 bytes、SHA-256 `1033ddb8c753c626208b2d503063b5a1d9eb7f6aa906a6f51f330d99cc8003ff`，再次通过证书 pin、v2 单 signer、16 KiB 对齐、最终权限和本地化标签/图标检查。设备覆盖安装与目视仍归采集可靠性计划。
