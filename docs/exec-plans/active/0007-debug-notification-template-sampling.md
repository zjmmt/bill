...
- 所有者：项目维护者
- 最后核验：2026-08-01
- 事实来源：用户 2026-07-31 明确授权的本轮新通知范围、4 条默认关闭的生产实验 route、通知来源规格、来源适配器设计与 Android 16 港版 S24 Ultra
...
- [x] 2026-07-31 - 在港版 S24 Ultra/API 36 重跑最终 app instrumentation 14/14：10 条 Debug 采样持久化/停止/分页用例、3 条隔离 route 偏好用例及 1 条当前 4-route catalog 默认关闭/仅持久化 opaque opt-in 用例全部通过。测试偏好与研究文件使用隔离路径，不读取或删除生产采样。
